...
namespace Lab
{
    ...
    class Student: Person, IDateAndCopy, INotifyPropertyChanged
    {
        ...
        public int Group
        {
            set { try
                {
                    if (value <= 100 || value > 599) throw new ArgumentOutOfRangeException("\nНеподобающее значение. (Группы: 100 < № <600");
                    else group = value;
                }
        ...
        public Student DeepCopyForSer() { 
            ...
            catch
            {
                ...
                throw new Exception("Error during DeepCopy making.");
            }
