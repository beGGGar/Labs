...
public class CollectionCreator {
    ...
    /**
     * Метод для создания линкдлиста
     * @return линкдлист с элементами типа Human
     */
     ...
     * @param cap 
     */
	public static ArrayList RunTimeList(int cap)
    {
        ...
        try {
            ...
            ans.add(addCountTime);
            ans.add(addCountTime / addCount);
            ans.add(deleteCountTime);
            ans.add( deleteCountTime / deleteCount);
     ...
     * @param cap кол-во обрабатываемых элементов
     */
    public static ArrayList RunTimeLinked(int cap)
    {
    	ArrayList<Long> ans = new ArrayList();
